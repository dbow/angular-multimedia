...
/**
 * Scales an image or video to fill the screen in both dimensions, preserving
 * its aspect ratio.
 *
 * Serves as a polyfill for the CSS object-fit: cover property if it is not
 ...
 */
function MediaCoverDirective($timeout) {
  return {
    ...
    link: function ($scope, $element, $attrs) {
      ...
      $element.addClass('media-cover-directive-polyfill');
      ...
      function checkMedia() {
        ...
        if (mediaElement) {
          ...
          if (mediaHeight && mediaWidth) {
            ...
            $mediaElement.toggleClass('media-cover-directive-x',
...
angular
  ...
  .directive('mediaCoverDirective', ['$timeout', MediaCoverDirective]);
